...
class TanitimActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       textView.text=secilenKahramanIsmi
        val secilenKahramanGörseli=intent.getIntExtra("superKahramanGörselleri",0)
        val bitmap=BitmapFactory.decodeResource(applicationContext.resources,secilenKahramanGörseli)
         imageView.setImageBitmap(bitmap)
      /*  val secilenKahraman=SingletonClass.SecilenKahraman
        val secilenGörsel=secilenKahraman.görsel
